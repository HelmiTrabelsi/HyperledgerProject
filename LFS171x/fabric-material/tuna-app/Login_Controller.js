...
console.log( Used)*/
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        ...
		        chaincodeId: 'Login',
		        fcn: 'AddHospital',
		        args: [key, HospitalName, Password, City],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
...
add_AB: function(req, res){
		console.log("submit recording of a tuna catch: ");
	const id1 = crypto.randomBytes(16).toString("hex");
	console.log(id1)
		var array = req.params.AB.split("-");
		console.log(array);
