...
return{
	get_all_receiver: function(req, res){
...
add_receiver: function(req, res){
		console.log("submit recording of a tuna catch: ");

		var array = req.params.receiver.split("-");
		console.log(array);
	var key              = array[0]
	var Poids            = array[1]
	var Taille           = array[2]
	var GroupeABO        = array[3]
	var StatusVirologique = array[4]
	var DegréDurgence     = array[5]
	var HLA               = array[6]
	var OrganDemande      = array[7]
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        ...
		        chaincodeId: 'tuna-app2',
		        fcn: 'AddReceiver',
		        args: [key, Poids, Taille, GroupeABO, StatusVirologique, DegréDurgence, HLA,OrganDemande],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
...
change_receiver_state: function(req, res){
		console.log("changing receiver state: ");

		var key = req.params.receiver
